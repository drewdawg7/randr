...
> **Note:** For new code, prefer using the `Row` and `Column` layout components from `src/ui/widgets/`. They provide more flexibility (padding, justify, align, sizing) with a builder API. See [layout_primitives.md](../widgets/layout_primitives.md).
