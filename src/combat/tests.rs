...
fn mob_on_death_returns_death_result() {
    ...
    let result = mob.on_death(0, |_| None);
...
fn mob_on_death_returns_empty_on_second_call() {
    ...
    let first_result = mob.on_death(0, |_| None);
    ...
    let second_result = mob.on_death(0, |_| None);
...
fn player_on_death_loses_gold_percentage() {
    ...
    let result = player.on_death(0, |_| None);
...
fn player_on_death_restores_health() {
    ...
    let _ = player.on_death(0, |_| None);
